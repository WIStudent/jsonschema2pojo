...
public class RequiredArrayJackson2IT {
    ...
    public static void generateClasses() throws IOException, ClassNotFoundException {
        ...
        ClassLoader resultsClassLoader = classSchemaRule.generateAndCompile("/schema/required/requiredArray.json", "com.example",
            config("annotationStyle", "jackson2"));
        
        classWithRequired = resultsClassLoader.loadClass("com.example.RequiredArray");
    }
